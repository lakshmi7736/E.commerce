...
public class OtpController {
    ...
    public String validateOtp(@ModelAttribute("verifyOtp") @RequestBody OtpValidationRequest otpValidationRequest,Model model) {
        ...
        try {
            ...
            if (otpSent) {
                return "redirect:/bee/"; // Redirect to "verifyOtp" page along with the username parameter
            } else {
